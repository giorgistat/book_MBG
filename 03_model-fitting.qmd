...
### Evaluating the inclusion of the measurement term and the specification of the smoothness parameter
...
Y_i = \mu + S(x_i) + U_i
$$ {#eq-galicia-lgm}
where were $S(x)$ is a Matern process with variance $\sigma^2$, scale parameter $\phi$ and and smothness parameter $\kappa$; the $U_i$ correspond to the measurement error term and denote with $\omega^2$ their variance. 
