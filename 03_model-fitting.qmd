...
The approach illustrated in this section to explore the association with gender, can also be applied to explora the association with other continuous variables which could also be a property of the household and not of the individual (e.g. elevation). 
