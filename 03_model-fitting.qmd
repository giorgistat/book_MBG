...
The use of simulation-based methods in the context of geostatistical analysis will be covered in more detail in @sec-geo-prediction. Here, we give a first introduction so as to understand how to simulate from a geostatistical model and how this can be used to obtain interval estimates for the model parameters using so called *parametric bootstrap*. 
