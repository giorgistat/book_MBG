...
$$ {#eq-glgm-lik1}
To simplify the explanation and notation in this section and the following ones, we will first rewrite the likelihood function in terms of the random effect \( W_i = S(x_i) + Z_i \). We will denote this in its vector form as \( W = (W_1, \ldots, W_n) \).
 $$
...
\end{cases}
$$
where $\rho(u;\phi,\kappa)$ is the Matern 
