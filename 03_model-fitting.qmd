...
Assessing the overdispersion of count data can be carried out in different ways depending on the goal of the statistical analysis. Since the focus of this book is to illustrate how to formulate and apply geostatistical models, the most natural approach to assess overdispersion is through the use of generalized linear mixed models (GLMMs). More specifically, in this section we use GLMMs that we shall use to assess overdispersion are obtained as a special case of the generalized linear geostatistical models presented in @sec-geostat-models. 
