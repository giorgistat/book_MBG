...
\hypertarget{exploring-associations-with-risk-factors}{%
\subsection{Exploring associations with risk
factors}\label{exploring-associations-with-risk-factors}}
...
In this section, we look more closely at the case of Binomial outcomes
which a require a different treatment from other type of outcomes. If
you want to read more on how to carry out exploratory analysis of the
data, we refer you to Chapter 1 of Weisberg (2014).

\hypertarget{when-the-outcome-is-an-aggregated-binomial-count}{%
\subsubsection{When the outcome is an aggregated Binomial
count}\label{when-the-outcome-is-an-aggregated-binomial-count}}
...
Before we move on, it is important to briefly discuss the differences
between using the logarithmic transformation
...
\(e \approx 2.718\) (Euler's number). To avoid this, one could rescale
the regression coefficient as, for example, \(\beta_1/\log_{2}(e)\)
which would be interpreted as the multiplicative change in the odds for
river-blindness for a doubling in elevation. However, a doubling in
elevation is less meaningful when considering larger values of
elevation.
...
help us to generate informative scatter plots.
...
\NormalTok{malkenya}\SpecialCharTok{$}\NormalTok{Age\_class }\OtherTok{\textless{}{-}} \FunctionTok{cut}\NormalTok{(malkenya}\SpecialCharTok{$}\NormalTok{Age, }
...
\NormalTok{age\_class\_data }\OtherTok{\textless{}{-}} \FunctionTok{aggregate}\NormalTok{(RDT }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Age\_class }\SpecialCharTok{+}\NormalTok{ Gender, }
                                    \AttributeTok{data =}\NormalTok{ malkenya, }
...
\NormalTok{glm\_age\_gender\_interaction }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(RDT }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Age }\SpecialCharTok{+}\NormalTok{ Gender}\SpecialCharTok{:}\NormalTok{Age }\SpecialCharTok{+} 
                              ...
                              \AttributeTok{data =}\NormalTok{ malkenya, }\AttributeTok{family =}\NormalTok{ binomial)}
...
\DocumentationTok{\#\#     data = malkenya)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                               Estimate Std. Error z value Pr(\textgreater{}|z|)    }
\DocumentationTok{\#\# (Intercept)                  {-}1.135655   0.089314 {-}12.715  \textless{} 2e{-}16 ***}
\DocumentationTok{\#\# Age                          {-}0.001674   0.008502  {-}0.197    0.844    }
\DocumentationTok{\#\# pmax(Age {-} 15, 0)            {-}0.095720   0.016123  {-}5.937 2.91e{-}09 ***}
\DocumentationTok{\#\# pmax(Age {-} 40, 0)             0.121917   0.022680   5.376 7.64e{-}08 ***}
\DocumentationTok{\#\# Age:GenderMale                0.007733   0.005080   1.522    0.128    }
\DocumentationTok{\#\# GenderMale:pmax(Age {-} 15, 0) {-}0.026943   0.022766  {-}1.183    0.237    }
\DocumentationTok{\#\# GenderMale:pmax(Age {-} 40, 0)  0.022514   0.040543   0.555    0.579    }
\DocumentationTok{\#\# {-}{-}{-}}
\DocumentationTok{\#\# Signif. codes:  0 \textquotesingle{}***\textquotesingle{} 0.001 \textquotesingle{}**\textquotesingle{} 0.01 \textquotesingle{}*\textquotesingle{} 0.05 \textquotesingle{}.\textquotesingle{} 0.1 \textquotesingle{} \textquotesingle{} 1}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# (Dispersion parameter for binomial family taken to be 1)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#     Null deviance: 8538.2  on 8203  degrees of freedom}
\DocumentationTok{\#\# Residual deviance: 8224.6  on 8197  degrees of freedom}
\DocumentationTok{\#\# AIC: 8238.6}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# 1      8200     8227.4                     }
\DocumentationTok{\#\# 2      8197     8224.6  3   2.8706    0.412}
\end{Highlighting}
\end{Shaded}
...
The approach illustrated in this section to explore the association with
gender, can also be applied to explora the association with other
continuous variables which could also be a property of the household and
not of the individual (e.g.~elevation).
